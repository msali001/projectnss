<?
	...
	chk_user();
	$id=$_GET['id'];
	$result=mysqli_query($con,"select * from student where studid=$id");
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="main">
  ...
  <tr>
    ...
    <table width="900" height="377" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="459"><div align="right" class="style1">Surname : </div></td>
      ...
      <tr>
        <td><div align="right" class="style1">Firstname : </div></td>
        <td><div align="left">
          <?=$row['studfirstname']; ?>
        </div></td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td height="22"><div align="right" class="style1">Loginid : </div></td>
        <td>
          <div align="left">
