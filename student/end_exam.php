<?
	...
	$id=$_POST['id'];
	$result=mysqli_query($con,"select * from questionbank where quesubject='$id'");
		...
		$per=($t*100)/$tq;
		$user=$_SESSION['cuser'];
		mysqli_query($con,"insert into examresult (studid,examdate,examtime,examsubject,examquetotal,examquetrue,examquefalse) values('$user','$date','$time','$id','$tq','$t','$f')");
?>
