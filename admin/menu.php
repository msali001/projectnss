...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30px">
      <tr>
        ...
        <td width="11%" style="border:solid 1px #CC0000"><div align="center"><a id="staf" href="./staff.php">Staff</a></div></td>        
        <td width="11%" style="border:solid 1px #CC0000"><div align="center"><a id="queri" href="./queries.php">Notification</a></div></td>        
